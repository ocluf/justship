...
<div>
    ...
    <div class="mx-auto max-w-2xl pt-20 pb-20 lg:pt-24 lg:pb-24">
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight sm:text-6xl">
          ...
          <span class="text-accent">opensource</span> svelte 5 saas boilerplate
          to ship
        ...
        <div class="mx-auto flex gap-5 w-fit mt-10">
          ...
          <a
            ...
            href="https://buy.stripe.com/fZeg0WcSa43cfXW8wy"
          >
  ...
  <div
    class="px-5 lg:px-10 pb-32 lg:pb-48 flex flex-wrap gap-10 lg:gap-14 justify-center"
  >
    <div>
      <svg
    ...
    <div>
      <svg
        ...
        ></svg
      >
      <div class="mt-3 font-semibold text-center text-opacity-80">
        tailwindcss
      </div>
    </div>
    <div>
