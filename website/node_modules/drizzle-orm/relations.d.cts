...
export declare function getOperators(): {
    ...
    eq: import("./sql/expressions/conditions.ts").BinaryOperator;
    exists: typeof exists;
    gt: import("./sql/expressions/conditions.ts").BinaryOperator;
    gte: import("./sql/expressions/conditions.ts").BinaryOperator;
    ilike: typeof ilike;
    inArray: typeof inArray;
    isNull: typeof isNull;
    isNotNull: typeof isNotNull;
    like: typeof like;
    lt: import("./sql/expressions/conditions.ts").BinaryOperator;
    lte: import("./sql/expressions/conditions.ts").BinaryOperator;
    ne: import("./sql/expressions/conditions.ts").BinaryOperator;
    not: typeof not;
...
export declare function createOne<TTableName extends string>(sourceTable: Table): <TForeignTable extends Table<import("./table.ts").TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
    tableName: TTableName;
}>, ...AnyColumn<{
    tableName: TTableName;
...
export declare function createMany(sourceTable: Table): <TForeignTable extends Table<import("./table.ts").TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable, config?: {
    relationName: string;
...
export declare function createTableRelationsHelpers<TTableName extends string>(sourceTable: AnyTable<{
    ...
    one: <TForeignTable extends Table<import("./table.ts").TableConfig<Column<any, object, object>>>, TColumns extends [AnyColumn<{
        tableName: TTableName;
    }>, ...AnyColumn<{
        tableName: TTableName;
    }>[]]>(table: TForeignTable, config?: RelationConfig<TTableName, TForeignTable["_"]["name"], TColumns> | undefined) => One<TForeignTable["_"]["name"], Equal<TColumns[number]["_"]["notNull"], true>>;
    many: <TForeignTable_1 extends Table<import("./table.ts").TableConfig<Column<any, object, object>>>>(referencedTable: TForeignTable_1, config?: {
        relationName: string;
