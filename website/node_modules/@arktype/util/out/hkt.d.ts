...
export declare namespace Hkt {
    ...
    export const pipe: <kinds extends UnaryKind<(In: any) => unknown>[], validatedKinds extends UnaryKind<(In: any) => unknown>[] = validatePipedKinds<kinds, Parameters<kinds[0]["hkt"]>[0]>>(...kinds: { [i in keyof kinds]: conform<kinds[i], validatedKinds[i & keyof validatedKinds]>; }) => pipe<kinds>;
    export {};
}
