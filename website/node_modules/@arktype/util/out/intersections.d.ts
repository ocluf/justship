...
type intersectSequences<l extends array, r extends array, prefix extends array, postfix extends array, intersector extends Hkt.Kind, kind extends SequenceIntersectionKind> = [
    parseNextElement<l, kind>,
    parseNextElement<r, kind>
] extends ([
    infer lState extends ElementParseResult,
    infer rState extends ElementParseResult
]) ? shouldRecurse<lState, rState, kind> extends true ? intersectSequences<lState["rest"], rState["rest"], [
    ...prefix,
    ...("head" extends lState["source"] | rState["source"] ? lState["optional"] | rState["optional"] extends true ? [
    ...
    ...prefix,
    ...(lState["rest"] extends readonly [] ? rState["rest"] extends readonly [] ? [] : kind extends "parameters" ? rState["rest"] : [] : rState["rest"] extends readonly [] ? kind extends "parameters" ? lState["rest"] : [] : Hkt.apply<intersector, [lState["head"], rState["head"]]>[]),
    ...postfix
] : never;
type shouldRecurse<lState extends ElementParseResult, rState extends ElementParseResult, kind extends SequenceIntersectionKind> = [
    lState["source"],
    rState["source"]
] extends [null, null] ? false : kind extends "parameters" ? true : [
    null,
    readonly []
] extends ([
    lState["source"],
    lState["rest"]
] | [rState["source"], rState["rest"]]) ? false : true;
...
type parseNextElement<elements extends array, kind extends SequenceIntersectionKind> = elements extends readonly [] ? result<{
