...
<div class="py-24 sm:py-32">
	<div class="mx-auto max-w-2xl px-6 lg:px-8">
		...
		<div>
			...
			<p class="mb-5 text-lg">
				These boilerplates can quite be valuable if they save you time, but it's hard to know what
				you're getting until you've purchased them!
			</p>
			<p class="mb-5 text-lg">
